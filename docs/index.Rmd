...
packages <- c("shiny", "rlang", "caret", "dplyr", "ggplot2", "readr")
...
#### Age:
Age group for n-year interval from exact age x to just before exact age x+n, where n=1, 4, 5, or infinity
...
### Probability an invidual of age x dies before age x, future life of age x
...
subset2 <- 1:56
cat("Presnet value of the annuity benefits for a 40 year old living until 95 =",sum(benefits[subset2] * discount_factors[subset2]))
```
